...
export function toCarbonActualIntent({ subjectId = null, purpose = null, action = 'read', objectId = null, metadata = {} } = {}) {
  return { type: 'intent', product: 'RITES', subjectId, purpose, action, objectId, metadata, authorityRef: null };
}

export function toCarbonActualAgentContract({ agentId, purpose, capabilities = [], subjectScope = [], requiredApprovals = [], sensitivityCeiling = 'restricted' } = {}) {
